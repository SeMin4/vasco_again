...
//        Call<Not_Complete_Data> getNotCompleteDetail(@Query("m_id") String m_id,@Query("ul_latitude") String lat,@Query("ul_longitude") String lng);
        ...
        @GET("/detail/unableLocate?") //기존지도에서 정보얻어오기 지도전체에 대한 수색불가정보
        Call<Not_Complete_Data> getNotCompleteDetail(@Query("m_id") String mid, @Query("ul_latitude") String lat, @Query("ul_longitude") String lng);
